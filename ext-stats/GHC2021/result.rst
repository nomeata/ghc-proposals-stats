...
* Syntax
  ...
  * Barely in: `MonadFailDesugaring`_, `TupleSections`_
...
* Types
  ...
  * Safely in: `EmptyDataDecls`_, `GADTSyntax`_, `RankNTypes`_, `StarIsType`_, `TypeApplications`_, `PolyKinds`_, `StandaloneKindSignatures`_
...
* Foreign function interface (FFI)
  ...
  * Safely in: `ForeignFunctionInterface`_
