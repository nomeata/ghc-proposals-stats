Data based on 13951 hackage packages, 1348 survey responses and 10 committee votes. (Votes may be changed.)
...
============================= ====== ======= ====== ====== ==== ===== =====
     ...
     `MultiParamTypeClasses`_  6.8.1     23%    37%    11%  27%   11%  100%
        `StandaloneDeriving`_  6.8.1     10%    26%     6%  22%   12%  100%
           `ConstraintKinds`_  7.4.1      9%    27%     7%  21%   19%   90%
            `DeriveFoldable`_ 7.10.1      5%    19%     2%  32%    9%   90%
             `DeriveFunctor`_ 7.10.1      9%    25%     6%  36%    8%   90%
                `DeriveLift`_  8.0.1      1%     2%     0%  19%   19%   90%
         `DeriveTraversable`_ 7.10.1      5%    19%     3%  29%   10%   90%
                 `EmptyCase`_  7.8.1      1%     5%     1%  18%   20%   90%
         `EmptyDataDeriving`_  8.4.1      0%      0     0%    0   N/A   90%
                `GADTSyntax`_  7.2.1      0%     0%      0  18%   24%   90%
       `ImportQualifiedPost`_ 8.10.1       0      0      0   4%   70%   90%
            `KindSignatures`_  6.8.1      7%    12%     4%  24%   12%   90%
            `NamedFieldPuns`_ 6.10.1      5%    10%     3%  18%   24%   90%
        `NumericUnderscores`_  8.6.1      0%     0%     0%  18%   15%   90%
          `PostfixOperators`_ 7.10.1      0%     0%     0%   3%  229%   90%
                `RankNTypes`_  6.8.1     21%    31%    12%  39%   22%   90%
   `ConstrainedClassMethods`_  6.8.1      0%     0%     0%   4%  138%   80%
 `ExistentialQuantification`_  6.8.1      7%     7%     6%  15%   30%   80%
`GeneralisedNewtypeDeriving`_  6.8.1     19%    31%    14%  28%   12%   80%
              `InstanceSigs`_  7.6.1      3%    11%     2%  19%   16%   80%
                 `PolyKinds`_  7.4.1      5%    11%     4%  11%   41%   80%
          `TypeApplications`_  8.0.1      6%    14%     5%  29%   11%   80%
             `TypeOperators`_  6.8.1     14%    28%     6%  20%   17%   80%
      `TypeSynonymInstances`_  6.8.1     10%     8%     7%   7%   74%   80%
                     `GADTs`_  6.8.1     13%    25%     8%  34%   13%   70%
            `MonoLocalBinds`_ 6.12.1      1%     1%     1%   2%  279%   70%
          `NegativeLiterals`_  7.8.1      0%     2%     0%   7%   58%   70%
           `RecordWildCards`_  6.8.1     17%    28%     9%  16%   39%   70%
       `ScopedTypeVariables`_  6.8.1     29%    41%    14%  33%    8%   70%
              `TypeFamilies`_  6.8.1     23%    33%    11%  24%   18%   70%
              `ViewPatterns`_ 6.10.1      7%    10%     6%  20%   22%   70%
                 `DataKinds`_  7.4.1     13%    28%     8%  26%   21%   60%
        `DerivingStrategies`_  8.2.1      1%     3%     1%  27%   11%   60%
               `DerivingVia`_  8.6.1      0%     1%     1%  30%   10%   60%
            `NamedWildCards`_ 7.10.1      0%     1%      0   8%   65%   60%
         `OverloadedStrings`_  6.8.1     37%    53%    12%  45%   12%   60%
             `TupleSections`_   6.12     10%    27%     7%  27%   12%   60%
  `ForeignFunctionInterface`_  6.8.1       0     4%      0   3%  211%   50%
                `LambdaCase`_  7.6.1     14%    34%     5%  46%    6%   50%
           `RoleAnnotations`_  7.8.1      1%     1%     1%   6%   75%   50%
  `StandaloneKindSignatures`_ 8.10.1      0%      0     0%   8%   28%   50%
                `StarIsType`_  8.6.1       0     0%      0    0   N/A   50%
             `UnicodeSyntax`_  6.8.1      2%     7%     0%   7%   99%   50%
         `DefaultSignatures`_  7.2.1      6%    19%     4%  16%   26%   40%
        `ExplicitNamespaces`_  7.6.1      1%     0%     1%   4%  138%   40%
       `MonadFailDesugaring`_  8.0.1      0%     2%      0   7%   15%   40%
 `NoMonomorphismRestriction`_  6.8.1      4%    11%     3%   4%  131%   40%
        `NullaryTypeClasses`_  7.8.1      0%      0      0   3%  145%   40%
               `NumDecimals`_  7.8.1      0%     1%     0%   4%  107%   40%
           `OverloadedLists`_  7.8.1      1%     1%     2%  10%   81%   40%
          `ParallelListComp`_  6.8.1      1%     9%     0%   4%  175%   40%
            `BlockArguments`_  8.6.1      0%     2%     0%  12%   63%   30%
  `DisambiguateRecordFields`_  6.8.1      0%     1%     0%   6%  105%   30%
    `FunctionalDependencies`_  6.8.1      9%    22%     6%  17%   27%   30%
                `MultiWayIf`_  7.6.1      4%    17%     2%  22%   20%   30%
    `TypeFamilyDependencies`_  8.0.1      1%     2%     1%   9%   59%   30%
          `UnliftedNewtypes`_ 8.10.1      0%      0      0   3%  121%   30%
           `LexicalNegation`_  9.0.1       0      0      0    0   N/A   20%
       `LiberalTypeSynonyms`_  6.8.1      1%     9%     0%   5%  105%   20%
  `NondecreasingIndentation`_      ?      0%     1%     0%    0   N/A   20%
     `PartialTypeSignatures`_ 7.10.1      1%     6%     1%   7%   84%   20%
           `PatternSynonyms`_  7.8.1      3%     6%     4%  14%   24%   20%
               `RecursiveDo`_  6.8.1      1%     2%     1%   5%  135%   20%
     `TemplateHaskellQuotes`_  8.0.1      0%     0%     0%   2%  446%   20%
                    `Arrows`_  6.8.1      2%     9%     0%   4%  284%   10%
     `DuplicateRecordFields`_  8.0.1      1%     4%     2%  11%   63%   10%
                 `MagicHash`_  6.8.1      4%     9%     2%   4%  160%   10%
            `PackageImports`_ 6.10.1      2%     3%     1%   6%   96%   10%
               `QuasiQuotes`_ 6.10.1      7%    14%     7%   6%  121%   10%
           `TemplateHaskell`_    6.0     18%    19%    17%   6%  176%   10%
               `UnboxedSums`_  8.2.1      0%      0     0%   4%  140%   10%
             `UnboxedTuples`_  6.8.1      3%     8%     1%   5%  134%   10%
          `UnliftedFFITypes`_  6.8.1      0%     0%     0%    0   N/A   10%
